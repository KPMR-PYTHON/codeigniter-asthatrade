<div id="content" class="clearfix">
				<div class="header">
					<h1 class="page-title">KRA File Download</h1>
                </div> <!-- /header -->
			<div class="breadcrumbs">
                <i class="fa fa-home"></i> Dashboard <i class="fa fa-caret-right"></i> KRA File Download
            </div>
                ...
                <div class="widget grid12">
                    <div class="widget-header">
                            <div class="widget-title">
                                <i class="fa fa-pencil"></i> KRA File Download
                            </div>
                        </div> <!-- /widget-header -->
