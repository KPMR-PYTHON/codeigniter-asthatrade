<div id="content" class="clearfix">
             ...
             <div class="fluid">
                ...
                <div class="widget grid12">
                    ...
                    <div class="widget-content pad20f">
                        ...
                        <form  action="<?php echo base_url(); ?>admin/paidUsersByDocument" method="post">                       
            ...
            <tr>
                ...
                <td class="table_head">Bank Acc Name</td>
                <td class="table_head">PAN</td>
                <td class="table_head">Ref By</td>
                ...
                <td class="table_head">Demat?</td>
				<td class="table_head">Doc</td>
				...
				<td class="table_head">Sig</td>
                <td class="table_head">IP</td>
            </tr>
            <?php
            ...
            <tr id="<?php echo $allAccountStatusList[$i]['user_id']; ?>">
                ...
                <td style="padding:5px; text-align:center;" ><a href="<?php echo base_url()."admin/viewUserDetails/".$allAccountStatusList[$i]['user_id'] ?>">
                    <font
                    <?php if($allAccountStatusList[$i]["is_offline"]){
                ...
                <td style="padding:5px; text-align:center;"><?php echo $allAccountStatusList[$i]['bankAccountHolderName']; ?></td>
                <td style="padding:5px; text-align:center;"><?php echo $allAccountStatusList[$i]['pancard']; ?></td>
                <td style="padding:5px; text-align:center;"><?php echo $allAccountStatusList[$i]['referred_by']; ?></td>
	...
	<!--	<td style="padding:5px; text-align:center;"><label name="disp_eq"><?php echo $allAccountStatusList[$i]['equity_receive_date']; ?></label>
		...
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["0"]; ?>" style="float:right;font-weight:bold;" target="_blank" >click here</a></td>
        
        <td style="padding:5px; text-align:center;">
            <?php if($allAccountStatusList[$i]["want_demat"]){ echo "Yes";} ?>
        </td>
        <td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["1"]; ?>" 
        target="_blank" <?php echo ($allAccountStatusList[$i]['is_doc_uploaded']==1 ? '': 'hidden') ?> >View</a></td>
		...
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["signature"]; ?>" target="_blank"  >View</a></td>
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["ip"]; ?>" target="_blank"  >View</a></td>
		
		
		
		<?php 	/*if($key1 !== false){ ?>
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["cc_proof"]; ?>" target="_blank"  >View Document</a></td>
		<?php } else { ?>
		<td style="padding:5px; text-align:center;"><a href="#"></a></td>
		<?php } */?>
