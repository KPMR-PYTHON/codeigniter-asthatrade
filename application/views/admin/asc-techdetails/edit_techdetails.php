    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>content/admin/ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css">
            ...
            <div id="content" class="clearfix">
                <div class="header">
                    <h1 class="page-title">Edit ACS Technical Details</h1>
                </div> <!-- /header -->
            <div class="breadcrumbs">
                <i class="fa fa-home"></i> Dashboard <i class="fa fa-caret-right"></i> Edit ACS Technical Details
            </div>
                ...
                <div class="widget grid12">
                    <div class="widget-header">
                            <div class="widget-title">
                                <i class="fa fa-pencil"></i> Edit ACS Technical Details
                            </div>
                        </div> <!-- /widget-header -->
                    
                    <div class="widget-content pad20f ">
                        <form enctype="multipart/form-data" id="addFrm" name="addFrm" action="<?Php echo base_url();?>Acstech/editAcsDetails" method="post">
                        <input type="hidden" name="id" value="<?php echo $asc_tech_details[0]['id'];?> ">
                        <select name="asc_cat_id" id="asc_cat_id" style="margin:1% 0;" required>
                            ...
                            ?>
                            <option value="<?php echo $val['id']; ?>" <?php if($asc_tech_details[0]['asc_cat_id'] == $val['id']): echo "selected"; endif; ?>><?php echo $val['asc_cat_name']; ?>
                            </option>
                            <?php    
                            }
                            ?>
                        </select>
                        <select name="asc_sub_cat_id" id="asc_sub_cat_id" style="margin:1% 0;" required>
                            <option value="">Please Select ASC Sub Category*</option>
                            <?php
                            foreach($acs_sub_cat as $val){
                            ?>
                            <option value="<?php echo $val['id']; ?>" <?php if($asc_tech_details[0]['asc_sub_cat_id'] == $val['id']): echo "selected"; endif; ?>><?php echo $val['asc_sub_cat_name']; ?></option>
                            <?php    
                            }
                            ?>
                        </select>
                        <!-- <input type="text" placeholder="Title *" value="<?php //echo $asc_tech_details[0]['heading']; ?>" name="heading" required="required"> -->
                        <div class="adjoined-bottom">
                            <div class="grid-container">
                                <div class="grid-width-100">
                                    ...
                                    <textarea name="editor" id="editor"><?php echo $asc_tech_details[0]['techninal_research_details'];?></textarea>
                                </div>
                            </div>
                        </div>
                        <br><br>
