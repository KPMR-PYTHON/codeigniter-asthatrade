                                            ...
                                            for($i=0;$i<$pageLength;$i++){ ?>
                                                <tr>
                                                    ...
                                                    <td style="padding:5px; text-align:center;">
                                                        <font <?php if($getUserList[$i]['is_offline']){
                                                            echo 'style="color:red"' ;
                                                        }?>

                                                            >
                                                            <?php echo $getUserList[$i]['fname'].$getUserList[$i]['mname'].' '.$getUserList[$i]['lname']; ?>
                                                    ...
                                                    echo ($getUserList[$i]['is_doc_uploaded']==1 ? "<p style='color:green'> Uploaded </p>": "<p style='color:red'>Not uploaded </p>");
                                                    ?></td>
                                                    <td style="padding:5px; text-align:center;">
                                                    <?php 
