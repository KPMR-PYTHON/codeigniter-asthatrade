<div id="content" class="clearfix">
		...
		<td class="table_head">Form Status</td>
                ...
                <td class="table_head">Equity eSigned Pdf</td>
                <td class="table_head">Commodity eSigned Pdf</td>
		...
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["0"]; ?>" style="float:right;font-weight:bold;" target="_blank" >(eSigned NSE Pdf )</a></td>
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["1"]; ?>" style="float:right;font-weight:bold;" target="_blank" >(eSigned MCX Pdf )</a></td>

		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]["2"]; ?>" 
