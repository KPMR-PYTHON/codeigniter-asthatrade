        <div id="content" class="clearfix">
            ...
            <div class="header">
                ...
                <h1 class="page-title">Commodity Online Payment Pending and Failed Users</h1>
                

            </div> <!-- /header -->

            <div class="breadcrumbs">
                <i class="fa fa-home"></i> Dashboard <i class="fa fa-caret-right"></i> Commodity Online Payment Pending and Failed Users
            </div>
                ...
                <div class="widget grid12">
                    <div class="widget-header">
                            <div class="widget-title">
                                <i class="fa fa-pencil"></i> Commodity Online Payment Pending and Failed Users
                            </div>
                        </div> <!-- /widget-header -->
            ...
            <?php
            if($getOnlinePendingCommodity){
            $i=1;
            foreach($getOnlinePendingCommodity as $users){
            ?>
            <tr>
                ...
                <a class="button" href="javascript:void(0)" onclick="addCode(<?php echo $users->usdId; ?>,6,<?php echo $users->status; ?>);">Add Code</a>
