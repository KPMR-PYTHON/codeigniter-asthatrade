<footer class="footer">
	...
	<!-- Form Validation -->
	<script type="text/javascript" src="<?php echo base_url(); ?>content/form_validation/jquery.form.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>content/form_validation/jquery.validate.js"></script>
