        <div id="content" class="clearfix">
            ...
            <div class="header">
                ...
                <h1 class="page-title">Equity Online Users</h1>
                

            </div> <!-- /header -->

            <div class="breadcrumbs">
                <i class="fa fa-home"></i> Dashboard <i class="fa fa-caret-right"></i> Equity Online Users
            </div>
                ...
                <div class="widget grid12">
                    <div class="widget-header">
                            <div class="widget-title">
                                <i class="fa fa-pencil"></i> Equity Online Users
                            </div>
                        </div> <!-- /widget-header -->
            ...
            if($getEquityOnline){
            $i=1;
            foreach($getEquityOnline as $users){
            ?>
            <tr>
                ...
                <a class="button" href="javascript:void(0)" onclick="addCode(<?php echo $users->usdId; ?>,1,<?php echo $users->status; ?>);">Add Code</a>
