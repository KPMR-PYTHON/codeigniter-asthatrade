<div id="content" class="clearfix">
		...
		<td style="padding:5px; text-align:center;"><label name="disp_form"><?php echo $allAccountStatusList[$i]['form_number']; ?>
</label>
		...
		<td style="padding:5px; text-align:center;"><a href="<?php echo $allAccountStatusList[$i]['image']; ?>" target="_blank">View Image</a></td>
