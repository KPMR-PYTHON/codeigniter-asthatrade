        <div id="content" class="clearfix">
            ...
            <div class="header">
                ...
                <h1 class="page-title">Commodity Online Users</h1>
                

            </div> <!-- /header -->

            <div class="breadcrumbs">
                <i class="fa fa-home"></i> Dashboard <i class="fa fa-caret-right"></i> Commodity Online Users
            </div>
                ...
                <div class="widget grid12">
                    <div class="widget-header">
                            <div class="widget-title">
                                <i class="fa fa-pencil"></i> Commodity Online Users
                            </div>
                        </div> <!-- /widget-header -->
            ...
            <?php
            if($getCommodityOnline){
            $i=1;
            foreach($getCommodityOnline as $users){
            ?>
            <tr>
                ...
                <td style="padding:5px; text-align:center;"><?php echo $users->transDate; ?></td>
                ...
                <a class="button" href="javascript:void(0)" onclick="addCode(<?php echo $users->usdId; ?>,4,<?php echo $users->status; ?>);">Add Code</a>
