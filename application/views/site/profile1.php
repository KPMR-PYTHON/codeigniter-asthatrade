...
<section>
    <div class="container">
        ...
        <p id="Message">
            <?php 
            if($this->session->flashdata('success_msg')){ echo $this->session->flashdata('success_msg');}else{ echo  $this->session->flashdata('err_msg');}
            if($this->session->flashdata('acc_msg')){ echo $this->session->flashdata('acc_msg');}else{ echo  $this->session->flashdata('acc_err_msg');}
            if($this->session->flashdata('succ_online_Equity')){ echo $this->session->flashdata('succ_online_Equity');}else{ echo  $this->session->flashdata('err_online_Equity');}
            if($this->session->flashdata('succ_online_commodity')){ echo $this->session->flashdata('succ_online_commodity');}else{ echo  $this->session->flashdata('err_online_commodity');}    
            if($this->session->flashdata('succ_offline_Equity')){ echo $this->session->flashdata('succ_offline_Equity');}else{ echo  $this->session->flashdata('err_offline_Equity');}
            if($this->session->flashdata('succ_offline_commodity')){ echo $this->session->flashdata('succ_offline_commodity');}else{ echo  $this->session->flashdata('err_offline_commodity');}
            
              if($getAccountPayDetails[0]['payment_type']=='1'){  // Payment Type 1 for Online
              if($getAccountPayDetails[0]['payment_status']=='0'){ // Payment Status 0 for Not Paid Yey
              if($getAccountPayDetails[0]['account_type']=='1'){ // Account Type 1 for Eqity Account
                echo "<br/>";
                echo "<br/>";
                echo "Equity Account Payment Pending. " ;?> <a class="none" href="<?php echo base_url();?>account/payForEquity">Pay Now</a>  <!-- MAke it a just hyper link -->
                <?php
            }
              else{ // Account Type 1 for Eqity Account
                
                echo "<br/>";
                echo "Commodity Account Payment Pending. "; ?> <a class="none" href="<?php echo base_url();?>account/payForCommodity">Pay Now</a> <!-- MAke it a just hyper link -->
                <?php
            }
        }
    }
    if($totCountOfAccountPay > 1){
              if($getAccountPayDetails[1]['payment_type']=='1'){  // Payment Type 1 for Online
              if($getAccountPayDetails[1]['payment_status']=='0'){ // Payment Status 0 for Not Paid Yey
              if($getAccountPayDetails[1]['account_type']=='1'){ // Account Type 1 for Eqity Account
                
                echo "<br/>";
                echo "Equity Account Payment Pending. " ;?> <a class="none" href="<?php echo base_url();?>account/payForEquity">Pay Now</a>  
                <?php
            }
              else{ // Account Type 2 for Commodity Account
                echo "<br/>";
                echo "<br/>";
                echo "Commodity Account Payment Pending. "; ?> <a class="none" href="<?php echo base_url();?>account/payForCommodity">Pay Now</a> 
                <?php
            }
        }
    }
          ...
          <ul class="tab-content">
                    ...
                    <div class="account_form2" style="font-size:14px;">
                        <form name="profile_edit" action="<?php echo base_url(); ?>account/updateProfile" method="post" enctype="multipart/form-data" onsubmit="return validation();"/>
                            <div style="border:1px solid #ccc;">
                                ...
                                <div class="col-1">
                                   <?php //print_r($getAccountPayDetails); ?>
                            ...
                            <div class="col-1" style="border-left:1px solid #ccc;">
                                <label>Payment Method :</label>
                            </div>
                            <div class="col-1">
                                <input type="hidden" name="payment_method" value="<?php echo $getAccountPayDetails[0]['payment_type'];?>">
                                <?php
                        ...
                        <div style="border:1px solid #ccc;">
                            ...
                            <div class="col-1">
                                ...
                                if($totCountOfAccountPay == 1){
                                    if($getAccountPayDetails[0]['account_type']=='1'){
                                        ?>
                                        <a style="color:#62c462;font-weight:bold;cursor:pointer;" onclick="window.location.href='#popup1';">Apply Now</a>
                                        <?php } else {?>
                                        <a style="color:#62c462;font-weight:bold;cursor:pointer;" onclick="window.location.href='#popup1';">Apply Now</a>
                                        <?php } } ?>
                                    </div>
                                ...
                                <?php }else if($totCountOfAccountPay > 1){?>
                                ...
                                <div style="border:1px solid #ccc;">
                                    ...
                                    <div class="col-1">
                                        <input type="hidden" name="payment_method" value="<?php echo $getAccountPayDetails[1]['payment_type'];?>">
                                        <?php
            ...
            <div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
                ...
                <div class="col-2">
                    ...
                    <input type="text" name="pan_card_no" id="pan_card_no" placeholder="PAN Card Number" value="<?php echo $getAllDetails['pancard']; ?>" readonly />
                </div>
            </div>
            <div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
                <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
                    ...
                    <input type="text" name="aadher_card" id="aadher_card" placeholder="UID / Aadhaar no" value="<?php echo $getAllDetails['addharcard']; ?>" readonly />
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
                <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
                    ...
                    <input type="text" name="address1" id="address1" placeholder="Address" value="<?php if($getAddressPresent['ad1'] != ''){echo $getAddressPresent['ad1'];}else{echo $getAddressPermanent['ad1'];} ?>" />
                </div>
                <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
                    <label> City / Town / Village :</label>
                    <?php //echo $getAddressPresent['ad2']; ?>
                    <input type="text" name="address2" id="address2" placeholder="City / Town / Village" value="<?php if($getAddressPresent['ad2'] != ''){echo $getAddressPresent['ad2'];}else{echo $getAddressPermanent['ad2'];} ?>" class="alphaonly" />
                </div>
                <div class="col-2" style="padding:5px;">
...
<div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
    <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
        ...
        <input type="text" name="peraddress1" id="peraddress1" placeholder="Address" value="<?php echo $getAddressPermanent['ad1']; ?>"/>
    </div>
    <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
        <label> City / Town / Village :</label>
        <?php // echo $getAddressPermanent['ad2']; ?>
        <input type="text" name="peraddress2" id="peraddress2" placeholder="City / Town / Village " value="<?php echo $getAddressPermanent['ad2']; ?>" class="alphaonly" />
    </div>
    <div class="col-2">
        <label> PIN Code :</label>
...
<div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
    ...
    <div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
        ...
        <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
            ...
            <?php //echo $getAllDetails['bankaddress'];?>
            <input type="text" name="banch_address" id="banch_address" value="<?php echo $getAllDetails['bankaddress'];?>" placeholder="Branch Address"/>
        </div>
        <div class="col-2">
            <label>City : </label>
            <?php //echo $getAllDetails['uAccCity'];?>
            <input type="text" name="branch_city" id="branch_city" value="<?php echo $getAllDetails['uAccCity'];?>" placeholder="City" class="alphaonly" />
        </div>
    </div>
    ...
    <div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
     ...
     <div class="col-2">
        ...
        <input type="text" name="acc_number" id="acc_number" value="<?php echo $getAllDetails['accNo'];?>"  placeholder="Account Number"/>
    </div>
</div>
...
<div style="border:1px solid #ccc; padding:0 5px; float:left; width:100%;">
    <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
        ...
        <input type="text" name="micr_number" id="micr_number" value="<?php echo $getAllDetails['micr'];?>" placeholder="MICR Number"/>
    </div> 
    <div class="col-2" style="border-right:1px solid #ccc;padding:5px;">
        ...
        <?php
            ...
            <div class="col-3">
             ...
             <table align="center" border="0" width="100%" style="text-align:center;margin: 0 auto;" >
                <?php
                
                    if($getAccountPayDetails[0]['payment_type']=='2'){ // For Offline 
                        ?>
                        <tr>
                            <?php
                    if($getAccountPayDetails[0]['account_type']=='1'){ // Checking in Respect of Equity Account
                        ?>
                        <td><a href="<?php echo base_url();?>account/save_download/<?php echo $this->session->userdata('id');?>/1" style="float:left;">Download Equity Pdf</a></td>
                        <?php } else { ?>
                        <td><a href="<?php echo base_url();?>account/save_download/<?php echo $this->session->userdata('id');?>/2" style="float:left;">Download Commodity Pdf</a></td>
                        <?php } ?>
                        <td>Or</td>
                        <?php 
                        if($getAccountPayDetails[0]['account_type']=='1'){
                            ?>
                            <!--<td><a href="<?php echo base_url();?>account/saveOnlineEquity"  style="float:right;">Apply For Equity Online</a></td>-->
                            <td><a href="<?php echo base_url();?>account/saveOnlineEquity"  style="float:right;">Switch to Equity Online Payment</a></td>
                            <?php                    
                        }
                        else{
                            ?>    
                            <!--<td><a href="<?php echo base_url();?>account/saveOnlineCommodity" style="float:right;">Apply For Commodity Online</a></td>-->
                            <td><a href="<?php echo base_url();?>account/saveOnlineCommodity" style="float:right;">Switch to Commodity Online Payment</a></td>
                            <?php    
                        } 
                        ?>
                    </tr>
                    <?php
                    } // End of Checking Offline 
                    
                    else // For Online Checking
                    {
                        ?>
                        <tr>
                            <?php
                        if($getAccountPayDetails[0]['account_type']=='1') // Checking is respect to Equity Account
                        {
                            
                            if($getAccountPayDetails[0]['payment_status']=='0')
                            {
                                ?>
                                <td><a href="<?php echo base_url();?>account/payForEquity" style="float:left;">Pay Now For Equity Account</a></td>
                                <?php 
                            } ?>
                            <td>Or</td>
                            <!--<td><a href="<?php echo base_url();?>account/saveOfflineEquity"  style="float:right;">Apply For Equity Offline</a></td>-->
                            <td><a href="<?php echo base_url();?>account/saveOfflineEquity"  style="float:right;">Switch to Equity Offline Payment</a></td>
                            <?php
                        }
                        else // This is for Commodity Checking
                        {
                            if($getAccountPayDetails[0]['payment_status']=='0')
                            {
                                ?>
                                <td><a href="<?php echo base_url();?>account/payForCommodity" style="float:left;">Pay Now For Commodity Account</a></td>
                                <?php 
                            }
                            ?>
                            <td>Or</td>
                            <!--<td><a href="<?php echo base_url();?>account/saveOfflineCommodity" style="float:right;">Apply For Commodity Offline</a></td>-->
                            <td><a href="<?php echo base_url();?>account/saveOfflineCommodity" style="float:right;">Switch to Commodity Offline Payment</a></td>
                            <?php
                ...
                if($totCountOfAccountPay == 1){
                    ...
                    <tr>
                        ...
                        if($getAccountPayDetails[0]['account_type']=='1'){
                            ?>
                            <td colspan="3"  valign="middle" ><a onclick="window.location.href='#popup1';" style="display:inline-block;">Apply For Commodity Account</a></td>
                            <?php } else {?>
                            <td colspan="3" valign="middle" ><a onclick="window.location.href='#popup1';" style="display:inline-block;">Apply For Equity Account</a></td>
                            <?php }  ?>
                        </tr>
                        <?php
                    }
                    else if($totCountOfAccountPay > 1){
                            if($getAccountPayDetails[1]['payment_type']=='2'){ // For Offline 
                                ?>
                                <tr>
                                    <?php
                    if($getAccountPayDetails[1]['account_type']=='1'){ // Checking in Respect of Equity Account
                        ?>
                        <td><a href="<?php echo base_url();?>account/save_download/<?php echo $this->session->userdata('id');?>/1" style="float:left;">Download Equity Pdf</a></td>
                        <?php } else { ?>
                        <td><a href="<?php echo base_url();?>account/save_download/<?php echo $this->session->userdata('id');?>/2" style="float:left;">Download Commodity Pdf</a></td>
                    ...
                    else // For Online Checking
                    {
                        ...
                        <tr>
                            <?php
                        if($getAccountPayDetails[1]['account_type']=='1') // Checking is respect to Equity Account
                        {
                            
                            if($getAccountPayDetails[1]['payment_status']=='0')
                            {
                                ?>
                                <td><a href="<?php echo base_url();?>account/payForEquity" style="float:left;">Pay Now For Equity Account</a></td>
                                <?php } ?>
                    ...
                    <tr>
                        <td colspan="3" style="text-align:center;">
                            <input class="save_btn" type="submit" name="edit_profile" placeholder="" value="SAVE CHANGES" style="float:none; padding:8px 80px; background:#0da0d3;"/>
                        </td>
                    </tr>
    ...
    <input id="padd" type="hidden" value="<?php echo $getAddressPermanent['ad1'];?>" >
    <input id="pcity" type="hidden" value="<?php echo $getAddressPermanent['ad2'];?>" >
...
function validation(){
    ...
    var banch_address=$('#banch_address').val();
    ...
    if(fname==''){
        ...
        $('#aadher_card').val('');
        $('#aadher_card').css({'border-color' : '#FF0000'});
        $('#aadher_card').attr("placeholder", "Please Enter Aadhar Card");
        $('#aadher_card').focus();
        return false;
    } else if(address1==''){
        $('#address1').val('');
        ...
        $('#address2').attr("placeholder", "Please Enter City / Town / Village");
        $('#address2').focus();
        return false;
    } else if(pin_code==''){
        $('#pin_code').val('');
        ...
        $('#peraddress2').attr("placeholder", "Please Enter Permanent City / Town / Village");
        $('#peraddress2').focus();
        return false;
    } else if(perpin_code==''){
        $('#perpin_code').val('');
        ...
        $('#bank_name').focus();
        return false;
    } else if(banch_address==''){
        $('#banch_address').val('');
        $('#banch_address').css({'border-color' : '#FF0000'});
        $('#banch_address').attr("placeholder", "Please Enter Branch Address");
        $('#banch_address').focus();
        return false;
    } else if(branch_city==''){
        $('#branch_city').val('');
...
function removeAdd()
{
    ...
    var peraddress1 = $('#peraddress1').val($('#padd').val());
    var peraddress2 = $('#peraddress2').val($('#pcity').val());
